                ...
                <div class="col-lg-10 offset-1">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            @foreach ( $edit as  $e)
                            <form action="{{route('Adminprofile#update',$e->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-4 offset-2 mt-5">
                                        ...
                                        @else
                                            <img src="{{asset('storage/'.$e->image)}}" alt="">
                                        @endif
                                    ...
                                    <div class="col-4 ">
                                        <div class="form-group">
                                            ...
                                            @error('name') is-invalid @enderror"
                                                ...
                                                placeholder="Enter Old password..." value="{{old('name',$e->name)}}">
                                            @error('name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @error('email') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false" placeholder="Enter Email..." value="{{old('email',$e->email)}}">
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @error('phone') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false"
                                                placeholder="Enter phone number..." value="{{old('phone',$e->phone)}}">
                                            @error('phone')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @error('role') is-invalid @enderror"
                                                aria-required="true" aria-invalid="false"
                                                placeholder="Enter Role..." disabled value="{{old('role',$e->role)}}">
                                            @error('role')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
