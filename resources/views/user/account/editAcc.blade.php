                            ...
                            <div class="row">
                                <div class="col-4 offset-2 mt-5">
                                    @if (Auth::user()->image==null)
                                        <img src="{{asset('image/user.png')}}" alt="" class="img-tumbnail " style="width:250px; height:250px;">
                                    @else
                                        <img src="{{asset('storage/'.Auth::user()->image)}}" alt="" style="width:250px; height:250px;">
                                    @endif
