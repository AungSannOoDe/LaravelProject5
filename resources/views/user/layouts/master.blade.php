                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <div class="collapse navbar-collapse justify-content-between ml-5" id="navbarCollapse">
                        ...
                        <a href="" class="btn px-0 ml-3 text-white">
                                <div class="dropdown show d-inline mr-4 bg-dark">
                                    <a class="btn btn-dark dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fa-solid fa-user"></i>  {{Auth::user()->name}}
                                    </a>

                                    <ul class="dropdown-menu">
                                      <li><a class="dropdown-item" href=""><i class="fa-solid fa-user"></i>  {{Auth::user()->name}}</a></li>
                                      <li><a class="dropdown-item" href="{{route('user#details')}}">Change password</a></li>
                                      <li>
